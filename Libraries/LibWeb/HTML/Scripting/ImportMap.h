...
using ModuleSpecifierMap = OrderedHashMap<String, Optional<URL::URL>>;
using ModuleIntegrityMap = OrderedHashMap<URL::URL, String>;
using ScopeMap = OrderedHashMap<URL::URL, ModuleSpecifierMap>;
...
public:
    ...
    ScopeMap const& scopes() const { return m_scopes; }
    ScopeMap& scopes() { return m_scopes; }
    void set_scopes(ScopeMap const& scopes) { m_scopes = scopes; }
